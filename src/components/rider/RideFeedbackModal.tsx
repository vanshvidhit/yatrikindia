...
export const RideFeedbackModal: React.FC<RideFeedbackModalProps> = ({ ride, onClose }) => {
  ...
  const handleSkip = () => {
    // Record into history with no written review
    addRideToHistory(ride, {
      rating: undefined,
  ...
  return (
    <div
      id="ride-feedback-modal-overlay"
      ...
      <div className="w-full max-w-lg bg-slate-900 border border-slate-700/80 rounded-3xl p-4 sm:p-5 shadow-2xl space-y-4 max-h-[92vh] overflow-y-auto">
        ...
        {isSubmitted ? (
          <div className="py-12 text-center space-y-3 animate-in zoom-in-95 duration-200">
            ...
            <h2 className="text-xl font-black text-white">Feedback Submitted!</h2>
            <p className="text-xs text-slate-300 max-w-xs mx-auto">
              Your {rating}★ rating and comments have been recorded in your ride history and shared with captain {driverName}.
            </p>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-950/60 border border-emerald-700/50 rounded-full text-emerald-300 text-xs font-mono">
              ...
              <span>Ride History Updated</span>
            </div>
          </div>
        ) : (
          <>
            ...
            <div className="text-center space-y-1 pt-1">
              ...
              <p className="text-xs text-slate-400">
                Rate your captain and leave feedback to help improve the platform.
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="text-[11px] font-semibold text-slate-300 flex items-center gap-1.5">
                ...
                <span>What went well? (Select compliments)</span>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                id="ride-feedback-comments-input"
                rows={3}
                maxLength={300}
                value={comments}
                onChange={(e) => setComments(e.target.value)}
                placeholder="Write a message for your captain or feedback for Yatrik India..."
            ...
            <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-2.5">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-slate-300 font-mono">#{ride.rideId}</span>
              </div>

              {/* Tip Selection Buttons */}
              <div className="space-y-1">
                <div className="text-[11px] text-slate-400">Add a Tip for Captain {driverName.split(" ")[0]}</div>
              ...
              <div className="pt-2 border-t border-slate-800 flex items-center justify-between text-xs">
                <span className="text-slate-300 font-semibold">Total Paid ({ride.paymentMethod || "UPI"})</span>
